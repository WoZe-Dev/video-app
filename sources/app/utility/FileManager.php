...
class FileManager
{
    ...
    private static $allowedExtensions = ['mp4', 'mpeg', 'mpg', 'mov', 'avi', 'webm', 'ogv'];

    private static $allowedSize = 10737418240; // 10 Go pour les vidéos

    public static function uploadGalleryVideo(array $file, int $userId, int $galleryId) : string|bool
    {
        ...
        // Define the target directory for gallery videos
        $targetDir = __DIR__. self::$baseUploadPath . '/gallery_videos/' . $userId . '/gallery_' . $galleryId;
        ...
        if (move_uploaded_file($file['tmp_name'], $destination)) {
            ...
            return '/uploads/gallery_videos/' . $userId . '/gallery_' . $galleryId . '/' . $uniqueFilename;
        }
    ...
    public static function deleteGalleryVideo(string $videoPath): bool
    {
        $fullPath = __DIR__ . self::$baseUploadPath . $videoPath;
